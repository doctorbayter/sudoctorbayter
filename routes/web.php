...
Route::get('/oferta', function () {
    return view('no-disponible'); 
    //return redirect('https://pay.hotmart.com/F78337495Q?off=gozf4qxe&checkoutMode=10');
})->name('oferta.reto');

Route::get('/97', function () {
    //return view('no-disponible'); 
    return redirect('https://pay.hotmart.com/F78337495Q?off=d6q16dhu&checkoutMode=10');
})->name('oferta.reto97');
...
Route::get('x/query/reto', function(){
    ...
    $recipe = Recipe::create([
        'name' => 'desafio-2024-3-1',
        'slug' => 'desafio-2024-3-1',
        'indice'=> 1,
        'carbs' => 0,
        'time' => 10,
        'type' => 1,
    ...
    (428, 171, $recipe->id, 1, CURRENT_TIMESTAMP, NULL)");

    $recipe = Recipe::create([
        'name' => 'desafio-2024-3-2',
        'slug' => 'desafio-2024-3-2',
        'indice'=> 1,
        'carbs' => 0,
        'time' => 35,
        'type' => 1,
    ...
    DB::insert("INSERT INTO day_recipe (id, day_id, recipe_id, meal, created_at, updated_at) VALUES
    (429, 171, $recipe->id, 2, CURRENT_TIMESTAMP, NULL)");


    $recipe = Recipe::create([
        'name' => 'desafio-2024-3-3',
        'slug' => 'desafio-2024-3-3',
        'indice'=> 1,
        'carbs' => 0,
        'time' => 20,
        'type' => 1,
    ...
    DB::insert("INSERT INTO day_recipe (id, day_id, recipe_id, meal, created_at, updated_at) VALUES
    (430, 171, $recipe->id, 3, CURRENT_TIMESTAMP, NULL)");
