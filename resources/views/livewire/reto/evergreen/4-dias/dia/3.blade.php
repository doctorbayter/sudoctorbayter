            ...
            <div class="w-10/12 md:w-7/12 mx-auto my-10" x-data="{selected:0}">
                <section class="mt-8 mb-20">
                    <div class="grid grid-cols-1 text-center">
                        <div class="border border-gray-100 font-bold cursor-pointer bg-gray-50 rounded-tl-md relative">
                            ...
                            <div class="grid overflow-hidden h-0 md:h-auto grid-cols-4 text-center shadow-md  absolute w-full " >
                                ...
                                <div class="font-semibold text-xs bg-red-700 text-red-100 cursor-default py-2"><span class="hidden md:block xl:inline">Día 3</div>
                    ...
                    <div class="w-10/12 grid md:hidden overflow-hidden grid-cols-4 text-center shadow-md absolute " >
                        ...
                        <div class="font-semibold text-xs  bg-red-700 text-red-100 cursor-default py-2 "><span class="hidden md:inline">Día</span> 3</div>
                ...
                <section class="mt-16 w-full">
                    <header class="md:mb-12">
                        <h2 class="text-3xl md:text-5xl font-bold">Menú <span class="text-red-700">Día 3</span></h2>
                        <p class="mb-4 text-gray-500"><img src="{{asset('img/icons/gfx/pie-chart.svg')}}" alt="" class="w-4 mr-1 inline opacity-40">Gramos de carbohidratos día <b>15,17</b></p>
                    </header>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-10 divide-y-2 md:divide-y-0 ">
                        <div class="pt-12 md:pt-0">
                            <a href="{{route('reto4.dia3.desayuno')}}">
                                <div class="relative h-62">
                                    ...
                                    <img src="{{asset('img/recipes/reto4-menu-dia-3-1.jpg')}}" alt="" class="rounded-2xl object-cover">
                                </div>
                                <div class="mt-2 ml-4">
                                    <p class="text-2xl mb-2 font-bold text-gray-900">Pizqueto</p>
                        ...
                        <div class="pt-12 md:pt-0">
                            <a href="{{route('reto4.dia3.almuerzo')}}">
                                <div class="relative h-62">
                                    ...
                                    <img src="{{asset('img/recipes/reto4-menu-dia-3-2.jpg')}}" alt="" class="rounded-2xl object-cover">
                                </div>
                                <div class="mt-2 ml-4">
                                    <p class="text-2xl mb-2 font-bold text-gray-900">HamburKetoromana</p>
                                    <div class="flex md:flex-col xl:flex-row md:items-start  text-xs items-center xl:items-center">
                                    <p class="bg-green-500 px-2 py-1 rounded-lg inline-block text-white">14,17 Carbs.</p>
                                    <p class="text-gray-400 ml-2 md:ml-0 md:my-1 xl:my-0 xl:ml-2 flex items-center">
                                        <img src="{{asset('img/icons/gfx/user.svg')}}" alt="" class="w-4 mr-1 opacity-40">
                                        <span>1 persona</span>                                                
                                    </p>
                        ...
                        <div class="pt-12 md:pt-0">
                            <a href="{{route('reto4.dia3.cena')}}">
                                <div class="relative h-62">
                                    ...
                                    <img src="{{asset('img/recipes/reto4-menu-dia-3-3.jpg')}}" alt="" class="rounded-2xl object-cover">
                                </div>
                                <div class="mt-2 ml-4">
                                    <p class="text-2xl mb-2 font-bold text-gray-900">Empanadas de pollo</p>
                                    <div class="flex md:flex-col xl:flex-row md:items-start  text-xs items-center xl:items-center">
