<div class=" max-w-lg">
    ...
    <input name="amount"        type="hidden"  value="{{$plan_price}}">
    <input name="tax"           type="hidden"  value="0">
    <input name="taxReturnBase" type="hidden"  value="0">
    <input name="currency"      type="hidden"  value="{{config('services.payu.base_currency')}}">
    <input name="signature"     type="hidden"  value="{{md5(config('services.payu.key').'~'.config('services.payu.merchant_id').'~'.$reference.'~'.$plan_price.'~'.config('services.payu.base_currency'))}}">
