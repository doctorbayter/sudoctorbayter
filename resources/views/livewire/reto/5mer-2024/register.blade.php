<div>
        ...
        <div class="py-12 flex flex-col-reverse md:flex-row max-w-5xl mx-auto">
            ...
            <div class="pl-2 w-full md:w-6/12 pr-2 mb-8 md:pl-12 md:pr-0 md:mb-0 ">
                <header class="leading-tight">
                    ...
                    <h1 class="text-3xl md:text-5xl font-bold leading-none pt-2">5<span class="text-red-700">MER</span></h1>
    ...
    <section class="bg-gray-900 py-12  ">
        <article class="max-w-3xl mx-auto text-gray-50 px-6 ">
            <div class="mb-8 ">
                ...
                <h3 class="text-lg text-gray-200 leading-none"><b class="text-yellow-400">Fecha de inicio:</b> LUNES 8 DE BRIL</h3>
            </div>
            ...
            <ul>
                <li class="mb-3 flex ">
                    ...
                    <p class=" flex-1">LUNES 8 DE ABRIL: Plan de alimentación + envío de información a través del grupo privado</p>
                </li>
                <li class="mb-3 flex">
                    <p class=""><b class="mr-4 text-yellow-400">Día 2:</b></p>
                    <p class=" flex-1">MARTES 9 DE ABRIL: Plan de alimentación + envío de información a través del grupo privado</p>
                </li>
                <li class="mb-3 flex">
                    <p class=""><b class="mr-4 text-yellow-400">Día 3:</b></p>
                    <p class=" flex-1">MIÉRCOLES 10 DE ABRIL: Plan de alimentación + envío de información a través del grupo privado</p>
                </li>
                <li class="mb-3 flex">
                    <p class=""><b class="mr-4 text-yellow-400">Día 4:</b></p>
                    <p class=" flex-1">JUEVES 11 DE ABRIL: Plan de alimentación + envío de información a través del grupo privado + Reunión privada VÍA ZOOM</p>
                </li>
                <li class="mb-3 flex">
                    <p class=""><b class="mr-4 text-yellow-400">Día 5:</b></p>
                    <p class=" flex-1">VIERNES 12 DE ABRIL:  Plan de alimentación + envío de información a través del grupo privad</p>
                </li>
            </ul>
        </article>
    </section>
    ...
    @push('footerText')
        <small class="italic text-gray-100 font-thin text-xs pb-2" >This site is not a part of the Facebook website or Facebook Inc. Additionally, This site is NOT endorsed by Facebook in any way. FACEBOOK is a trademark of FACEBOOK, Inc.</small>
    @endpush
</div>
