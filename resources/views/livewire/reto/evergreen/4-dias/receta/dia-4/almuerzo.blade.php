    ...
    <div class="flex">
        <div class="bg-white  mx-auto w-full">
            <header class="shadow-lg relative">
                ...
                <h2 class=" font-bold text-3xl md:text-6xl">Diablitos ketozuquinis</h2>
                <div class="flex text-xs items-center">
                    <p class="bg-green-500 px-2 py-1 rounded-lg inline-block text-white">22,57g Carbs.</p>
            ...
            <div class="absolute w-full h-full bg-fixed bg-center top-0 left-0 opacity-40" style="background-image: url({{asset('img/recipes/reto4-menu-dia-4-2.jpg')}})"></div>
        </header>
                ...
                <div class="flex flex-col xl:flex-row">
                    <div class=" w-full xl:w-4/12 ">
                        <figure class="rounded-t-xl overflow-hidden">
                            <img src="{{asset('img/recipes/reto4-menu-dia-4-2.jpg')}}" alt="" class=" w-full object-cover">
                        </figure>
                        <div class=" bg-gray-200 rounded-b-xl px-4 py-8">
                            ...
                            <ul class="mt-6 text-sm text-gray-600">
                                <li class="mb-6 leading-snug relative pl-6"> <i class="fas fa-check text-red-700 absolute left-0"></i>150 a 180 gramos de camarones grandes, pre cocidos y limpios (lo puedes cambiar por la proteína de tu gusto)</li>
                                <li class="mb-6 leading-snug relative pl-6"> <i class="fas fa-check text-red-700 absolute left-0"></i>30 gramos de cebolla roja finamente picada (2,79 gr. CH )</li>
                                <li class="mb-6 leading-snug relative pl-6"> <i class="fas fa-check text-red-700 absolute left-0"></i>1(2 gramos) diente de ajo finamente picado (0,48 gr. CH)</li>
                                <li class="mb-6 leading-snug relative pl-6"> <i class="fas fa-check text-red-700 absolute left-0"></i>Media taza de consomé de pollo o pescado</li>
                                <li class="mb-6 leading-snug relative pl-6"> <i class="fas fa-check text-red-700 absolute left-0"></i>2 cucharadas de pasta de tomate cacera</li>
                                <li class="mb-6 leading-snug relative pl-6"> <i class="fas fa-check text-red-700 absolute left-0"></i>1/2 cucharadita de ají o jalapeño o salsa picante</li>
                                ...
                                <li class="mb-6 leading-snug relative pl-6"> <i class="fas fa-check text-red-700 absolute left-0"></i>250 gramos de zuquinni (8,25 gr. CH)</li>
                                <li class="mb-6 leading-snug relative pl-6"> <i class="fas fa-check text-red-700 absolute left-0"></i>130 gramos de aguacate (11,05 gr. CH)</li>
                                <li class="mb-6 leading-snug relative pl-6"> <i class="fas fa-check text-red-700 absolute left-0"></i>1/2 cucharadita de albahaca finamente picado</li>
                    ...
                    <div class="xl:ml-16 mt-12 md:mt-0 flex-1">
                        ...
                        <ul class=" divide-y mt-8">
                            <li class="flex pb-6 pt-4">
                                ...
                                <p>En un sarten con mantequilla y a fuego bajo pones a sofreír la cebolla, ajo hasta que esten doraditos</p>
                            </li>
                            <li class="flex pb-6 pt-4">
                                <span class="bg-red-700 text-white font-bold w-8 h-8 px-3 md:px-0 leading-8 text-center rounded-full mr-4 text-sm">2</span>
                                <p>Añades el consomé y cuando este hirviendo y bien reducido</p>
                            </li>
                            <li class="flex pb-6 pt-4">
