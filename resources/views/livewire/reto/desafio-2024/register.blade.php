    ...
    <section class="" style="">
        ...
        <div class="py-12 flex flex-col-reverse md:flex-row max-w-5xl mx-auto">
            <div class=" w-full md:w-6/12">
                <img src="{{asset('img/billboards/doctor_bayter_desafio_2024.jpg')}}" alt="" class="w-full my-4 md:my-0"/>
            </div>
            <div class="pl-2 w-full md:w-6/12 pr-2 mb-8 md:pl-12 md:pr-0 md:mb-0 ">
                <header class="leading-tight">
                    ...
                    <h1 class="text-3xl md:text-5xl font-bold leading-none pt-2">Desafío<span class="text-red-700">2024</span></h1>
                    <h2 class="text-base md:text-2xl">Liberate de la mierda del 2023</h2>
                </header>
                <p class="my-4 text-sm md:text-base text-justify">Porque este es tu año. Esta es tu oportunidad. Este 2024 vas a dejar de decir "el lunes comienzo la dieta" para decir "INICIO HOY". Y qué mejor que con un espectacular reto de 5 días en el que vas a eliminar toda la mierda que comiste en el 2023.</p>
                ...
                <p class="my-4 text-sm md:text-base text-justify">Durante 5 días te voy a llevar de la mano en un camino maravilloso  en el que lograrás disminuir los carbohidratos a su mínima expresión, desinflamarte, y  preparar tu cuerpo para lo que se viene… porque en esta Navidad ¡SÍ vas a comer para sanar!</p>
                <p class="my-4 text-sm md:text-base text-justify">Te voy a demostrar que tan solo en 5 días tu cuerpo estará listo para comer delicioso Y BAJAR ESA MIERDA QUE ACUMULASTE EN EL 2023.</p>
                <div class="relative">
            ...
            <div class="text-gray-50  w-full lg:w-8/12  px-4 md:mr-0 md:ml-10">
                ...
                <ul class="text-sm md:text-base">
                    <li class="mb-4 relative pl-6 text-justify">
                     ...
                     <li class="mb-4 relative pl-6 text-justify">
                        <i class="far fa-check-square text-yellow-400 mr-2 absolute top-1 left-0"></i>
                        <span>1 reunión por Zoom y Youtube privado con tu Doctor Bayter donde aprenderás todos los secretos para que este año te conviertas en una máquina QUEMA GRASA.</span>
                    </li>
    ...
    <section class="max-w-3xl py-24 mx-auto ">
            ...
            <div class="flex flex-col lg:flex-row items-center justify-between mb-16">
                ...
                <div class="lg:ml-10 px-4 lg:px-4">
                    <h2 class="font-semibold text-2xl lg:text-3xl mb-4 text-red-700">¿Cómo serán estos 5 días? Fecha de inicio: MARTEs 9 DE ENERO</h2>
    ...
    <section class="bg-gray-900 py-12  ">
        <article class="max-w-3xl mx-auto text-gray-50 px-6 ">
            <div class="mb-8 ">
                ...
                <h3 class="text-lg text-gray-200 leading-none"><b class="text-yellow-400">Fecha de inicio:</b> MARTES 9 de ENERO</h3>
            </div>
            ...
            <ul>
                <li class="mb-3 flex ">
                    ...
                    <p class=" flex-1">MARTES 9 DE ENERO: Plan de alimentación + envío de información a través del grupo privado</p>
                </li>
                <li class="mb-3 flex">
                    <p class=""><b class="mr-4 text-yellow-400">Día 2:</b></p>
                    <p class=" flex-1">MIÉRCOLES 10 DE ENERO: Plan de alimentación + envío de información a través del grupo privado</p>
                </li>
                <li class="mb-3 flex">
                    <p class=""><b class="mr-4 text-yellow-400">Día 3:</b></p>
                    <p class=" flex-1">JUEVES 11 DE ENERO: Plan de alimentación + envío de información a través del grupo privado</p>
                </li>
                <li class="mb-3 flex">
                    <p class=""><b class="mr-4 text-yellow-400">Día 4:</b></p>
                    <p class=" flex-1">VIERNES 12 DE ENERO: Plan de alimentación + envío de información a través del grupo privado + Reunión privada vía zoom y youtube</p>
                </li>
                <li class="mb-3 flex">
                    <p class=""><b class="mr-4 text-yellow-400">Día 5:</b></p>
                    <p class=" flex-1">SÁBADO 13 DE ENERO:  Plan de alimentación + envío de información a través del grupo privado</p>
                </li>
            </ul>
        </article>
    </section>
