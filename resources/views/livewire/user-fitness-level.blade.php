<div class="bg-gradient-to-b min-h-screen from-gray-800 to-gray-900">
    <section class="grid grid-cols-6">
        <div class="col-span-6 order-first md:col-span-2 ">
            ...
            <div class="hidden md:inline-block h-screen bg-cover bg-no-repeat bg-right-top w-full sticky top-0 " style="background-image: url({{asset('img/billboards/fitness/nivel_1_lg.jpg')}})"  alt=""></div>

            <article class="col-span-2 md:col-span-1 md:hidden bg-cover bg-right-top bg-no-repeat h-48 relative group" style="background-image: url({{asset('img/billboards/fitness/nivel_1.jpg')}})">
        ...
        <div class="col-span-6 md:col-span-4 md:px-16 " x-data="{selected:1}">
            ...
            <div class="grid grid-cols-3 gap-x-0.5 text-center bg-gray-900">
                                    ...
                                    <div class="flex px-4 py-6 items-start">
                                        ...
                                        <div class="ml-4 flex-1">
                                            ...
                                            <ul class="text-blue-200 text-xs pl-2 mt-1">
                                                ...
                                                <li><i class="fas fa-running mr-2 mb-2"></i>{{$training["type"]}}</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <aside x-on:click="descriptionIsShowing = !descriptionIsShowing"  class="bg-gray-900 bg-opacity-75 md:hidden">
