<x-app-layout>
    ...
    <section class="bg-gray-50 pt-12 pb-24">
        <div class="max-w-7xl mx-auto relative px-6 md:px-0">
            <header class="mb-12">
                <h2 class="text-xl md:text-3xl text-center font-bold text-gray-900">¿PARA QUIEN ES ESTE <span class="text-red-700">PLAN</span>?</h2>
                <p class="text-center my-4 text-lg">Este plan está diseñado especialmente para aquellos que están decididos a transformar su vida a través de la dieta Keto Perfecta.</p>
            </header>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-9">
                <div class="px-6 py-4 overflow-hidden rounded-xl transition-all duration-300 ease-in-out hover:shadow-xl hover:bg-gray-200 hover:scale-110">
                    ...
                    <p class="text-2xl mb-4"><b>Keto Principiantes</b></p>
                    <p class="text-justify">Si estás explorando la dieta Keto por primera vez y buscas una guía confiable para empezar con el pie derecho, este plan te proporcionará las bases sólidas que necesitas para un inicio exitoso y sostenible.</p>
                </div>
                <div class="px-6 py-4 overflow-hidden rounded-xl transition-all duration-300 ease-in-out hover:shadow-xl hover:bg-gray-200 hover:scale-110">
                    <i class="text-5xl text-red-700 mb-4 fa fa-sync-alt"></i> 
                    <p class="text-2xl mb-4"><b>Intentador Recurrente</b></p>
                    <p class="text-justify">Para aquellos que han intentado la dieta Keto en el pasado sin éxito y se encuentran listos para darle una nueva oportunidad con una estrategia clara y apoyo constante, este plan es la oportunidad de reescribir su historia con Keto.</p>
                </div>
                <div class="px-6 py-4 overflow-hidden rounded-xl transition-all duration-300 ease-in-out hover:shadow-xl hover:bg-gray-200 hover:scale-110">
                    <i class="text-5xl text-red-700 mb-4 fa fa-lightbulb"></i> 
                    <p class="text-2xl mb-4"><b>Buscador de Claridad</b></p>
                    <p class="text-justify">Si te sientes abrumado por la cantidad de información contradictoria sobre Keto y deseas un enfoque claro, basado en evidencia y fácil de seguir, este plan te brindará la claridad y dirección que necesitas para avanzar con confianza.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-gray-900 py-12 md:py-20 ">
        ...
        <a href="https://pay.hotmart.com/G90883691T?checkoutMode=6&off=ucf5h58x&offDiscount=7DKP" target="_blank" class="hotmart-fb block max-w-3xl mx-auto text-center mt-8">
            <span class="cta-btn relative overflow-hidden w-full my-8 text-center rounded-full inline-block sm:text-2xl font-bold px-4 py-2 border bg-red-700 border-red-700 text-white uppercase transition-colors duration-300 ease-in-out  hover:bg-transparent hover:text-red-700 ">
                ...
                <small class="block text-xs font-normal">Adquiere la oferta especial con un 70% de descuento con el código <b>7DKP</b></small>
            </span>
        </a>
    </section>
                            ...
                            <div class="px-6 pt-4 pb-6">
                                ...
                                <div class="grid lg:grid-cols-3 gap-x-4">
                                    <ul class="list-disc font-normal px-6 mt-4">
                                        ...
                                        <li class="text-base mb-2">
                                            <p>Secuelas de un infarto</p>
                                        </li>
                                        <li class="text-base mb-2">
                                            <p>Pacientes en los que la epilepsia es secundaria a un trastorno estructural tipo tumor en el cerebro, malformación arteriovenosa, aneurisma o cualquier masa intracerebral</p>
                                        </li>
                                        <li class="text-base mb-2">
                                            <p> Cuando tengan una enfermedad asociada a la epilepsia</p>
                                        </li>
                                        <li class="text-base mb-2">
                                            <p>Obstrucción arterial (ya sea coronaria, cerebral o de cualquier arteria)</p>
                                        </li>
                                        <li class="text-base mb-2">
                                            <p>Infartos previos (cerebral o corazón)</p>
                                        </li>
                                        <li class="text-base mb-2">
                                            <p>Enfermedad coronaria reciente</p>
                                        </li>
                                    </ul>
                                    <ul class="list-disc font-normal px-6 mt-0 lg:mt-4">   
                                        <li class="text-base mb-2">
                                            <p>Trastornos hepáticos con encimas hepáticas alteradas</p>
                                        </li>
                                        <li class="text-base mb-2">
                                            <p>Enfermedad hepática crónica</p>
                                        </li>
                                        <li class="text-base mb-2">
                                            <p>Insuficiencia renal o hepática</p>
                                        </li>
                                        <li class="text-base mb-2">
                                            <p>Diabéticos tipo 1</p>
                                        </li>
                                        <li class="text-base mb-2">
                                            <p>Pacientes con stent coronario, carotideo o cerebral</p>
                                        </li>
                                        <li class="text-base mb-2">
                                            <p>Pacientes que se hayan realizado angioplastia coronaria</p>
                                        </li>
                                        <li class="text-base mb-2">
                                            <p>acientes que se hayan realizado Angioplastia</p>
                                        </li>
                                        <li class="text-base mb-2">
                                            <p>Pacientes diagnosticados con angina estable o inestable en el pasado</p>
                                        </li>
                                    </ul>
                                    <ul class="list-disc font-normal px-6 mt-0 lg:mt-4">
                                        <li class="text-base mb-2">
                                            <p>Pacientes con enfermedad cerebrovascular</p>
                                        </li>
                                        <li class="text-base mb-2">
                                            <p>Pacientes con isquemia cerebral transitoria o permanente</p>
                                        </li>
                                        <li class="text-base mb-2">
                                            <p>Pacientes con cirrosis o daño hepático</p>
                                        </li>
                                        <li class="text-base mb-2">
                                            <p>Índice de masa corporal menor a 18</p>
                                        </li>
                                        <li class="text-base mb-2">
                                            <p>Menores de 18 años</p>
                                        </li>
                                        <li class="text-base mb-2">
                                            <p>Mayores de 80 años</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
    ...
    <div id="exitIntentPopup" class="fixed inset-0 bg-black bg-opacity-80 hidden z-50 flex justify-center items-center" style="backdrop-filter: blur(10px);">
        <div class="opacity-0 scale-95 transform transition-transform duration-300 ease-out max-w-4xl py-12 px-8 mx-4 sm:mx-auto p-6 bg-white rounded-lg shadow-xl relative" id="popupContent">
            ...
            <div class="text-center">
                ...
                <a  href="https://pay.hotmart.com/G90883691T?checkoutMode=6&off=ucf5h58x&offDiscount=7DKP" class="block w-11/12 mx-auto rounded-xl p bg-red-700 hover:bg-red-900 text-white font-bold px-4 py-4 text-sm sm:text-3xl uppercase relative overflow-hidden cta-btn">¡Quiero Aprovechar la Oferta!</a>
    ...
    @push('scriptsHead')
        ...
        <script type="application/ld+json">
            {
                ...
                "mainEntityOfPage": {
                    "@type": "WebPage",
                    "@id": "https://www.doctorbayter.com/7DKP"
                }
            }
        </script>
        <!-- Swiper JS -->
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const targetDuration = 1.75 * 60 * 60 * 1000; // 1 hora y 45 minutos en milisegundos
