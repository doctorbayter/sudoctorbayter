            ...
            @can('enrolledFase', $fase)
                ...
                <div :class="{'w-7/12': openMenu, 'w-11/12': !openMenu}" class="bg-white  ml-auto">
                    ...
                    @if ($fase->id == 5)
                        <header class="">
                            <figure>
                                <img src="{{asset('img/billboards/7_dias_keto.png')}}" alt="">
                            </figure>
                        </header>
                        <section class=" bg-black bg-opacity-80 px-8 py-12 text-gray-100">
                            <h2 class=" font-bold text-3xl md:text-6xl">{{auth()->user()->name}}, te damos la bienvenida a tus primeros 7 días <span class="text-red-700">Keto</span> Perfectos.</h2>
