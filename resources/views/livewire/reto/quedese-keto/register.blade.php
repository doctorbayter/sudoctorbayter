        ...
        <div class="py-12 flex flex-col-reverse md:flex-row max-w-5xl mx-auto">
            ...
            <div class="pl-2 w-full md:w-6/12 pr-2 mb-8 md:pl-12 md:pr-0 md:mb-0 ">
                <header class="leading-tight">
                    ...
                    <h1 class="text-3xl md:text-5xl font-bold leading-none pt-2">#QUEDESE<span class="text-red-700">KETO</span></h1>
            ...
            <div class="text-gray-50  w-full lg:w-8/12  px-4 md:mr-0 md:ml-10">
                ...
                <ul class="text-sm md:text-base">
                    <li class="mb-4 relative pl-6 text-justify">
                        ...
                        <span class="">Todas las recetas: desayuno, almuerzo, cena de tu día a día, lista de alimentos y los mejores secretos para prepararte para las fiestas y quedarte keto.</span>
                    </li>
                     <li class="mb-4 relative pl-6 text-justify">
                        <i class="far fa-check-square text-yellow-400 mr-2 absolute top-1 left-0"></i>
    ...
    <section class="bg-gray-900 py-12  ">
        <article class="max-w-3xl mx-auto text-gray-50 px-6 ">
            <div class="mb-8 ">
                ...
                <h3 class="text-lg text-gray-200 leading-none"><b class="text-yellow-400">Fecha de inicio:</b> Lunes 12 de diciembre 2022</h3>
            </div>
            ...
            <ul>
                <li class="mb-3 flex ">
                    ...
                    <p class=" flex-1">Lunes 12 de diciembre, día 1: Reunión privada de zoom con tu Doctor Bayter + plan de alimentación + video receta </p>
                </li>
                <li class="mb-3 flex">
                    <p class=""><b class="mr-4 text-yellow-400">Día 2:</b></p>
                    <p class=" flex-1">Martes 13 de diciembre, día 2: Plan de alimentación + video receta </p>
                </li>
                <li class="mb-3 flex">
                    <p class=""><b class="mr-4 text-yellow-400">Día 3:</b></p>
                    <p class=" flex-1">Miércoles 14 de diciembre, día 3: Plan de alimentación + video receta </p>
                </li>
                <li class="mb-3 flex">
                    <p class=""><b class="mr-4 text-yellow-400">Día 4:</b></p>
                    <p class=" flex-1">Jueves 15 de diciembre, día 4: Plan de alimentación + video receta </p>
                </li>
                <li class="mb-3 flex">
                    <p class=""><b class="mr-4 text-yellow-400">Día 5:</b></p>
                    <p class=" flex-1">Viernes 16 de diciembre, día 5: Reunión privada de zoom con tu Doctor Bayter + plan de alimentación + video receta </p>
                </li>
            </ul>
        </article>
    </section>
