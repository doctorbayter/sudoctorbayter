<div>
        ...
        <div class="py-12 flex flex-col-reverse md:flex-row max-w-5xl mx-auto">
            ...
            <div class="pl-2 pr-2 mb-8 md:pl-12 md:pr-0 md:mb-0 ">
                <header class="leading-tight">
                    <p class="text-sm md:text-xl inline bg-red-700 text-gray-50 px-4"><b>Nuevo Desafio</b> 100% Online</p>
                ...
                <p class="my-4 text-sm md:text-base text-justify">Porque este es tu año. Esta es tu oportunidad. Este 2022 vas a dejar de decir "el lunes comienzo la dieta" para decir "INICIO HOY". Y qué mejor que con un espectacular Desafio de 5 días en el que vas a eliminar toda la mierda que comiste en el 2021.</p>
    ...
    <section class="bg-gray-900 py-12">
        <div class="max-w-4xl mx-auto flex w-full flex-col-reverse md:flex-row">
            ...
            <div class="text-gray-50  w-full lg:w-8/12  px-4 md:mr-0 md:ml-10">
                <h2 class="font-bold mb-4 text-2xl leading-none">¿Qué incluye este Desafio?</h2>
                <ul class="text-sm md:text-base">
                    <li class="mb-4 relative pl-6 text-justify">
                        <i class="far fa-check-square text-yellow-400 mr-2 absolute top-1 left-0"></i>
                        <span class="">Menú de tu día a día durante los 5 días del Desafio.</span>
                    </li>
                     <li class="mb-4 relative pl-6 text-justify">
                        <i class="far fa-check-square text-yellow-400 mr-2 absolute top-1 left-0"></i>
                ...
                <div>
                    ...
                    <p class=" uppercase">Este DESAFIO es <span class="font-bold">100% online </p>
    ...
    <section class="bg-gray-900 py-12  ">
        <article class="max-w-3xl mx-auto text-gray-50 px-6 ">
            ...
            <p class="text-xl font-light mb-8">Esto es lo que verás en cada uno de los días del desafio:</p>
            <ul>
                <li class="mb-3 flex ">
    ...
    <section class="max-w-4xl mx-auto">
        <div class="py-16">
            <h2 class="font-bold mb-8 text-3xl text-center">¿Para quién es este desafio?</h2>
            <div class="grid lg:grid-cols-3 gap-x-6 gap-y-4">
                ...
                <div class="bg-gray-100 px-6 py-4 rounded-lg shadow-sm">
                    ...
                    <p class="text-sm">Este es el desafio perfecto para cambiar de hábitos y mejorar la salud.</p>
                </div>
                <div class="bg-gray-100 px-6 py-4 rounded-lg shadow-sm">
        ...
        <article class="max-w-3xl mx-auto text-gray-50 px-6 ">
            ...
            <ul>
                <li class="mb-3 flex ">
                    ...
                    <p class=" flex-1 text-justify"><b> ¿Qué me llega al pagar? <br></b> Al momento del pago, te llegará un correo de confirmación para ingresar al grupo de WhatsApp. La información del desafio la tendrás disponible el día viernes 7 de enero en tu cuenta. Para acceder a esta, debes iniciar sesión en doctorbayter.com con el correo y contraseña que registraste cuando realizaste el pago.</p>
                </li>
                <li class="mb-3 flex">
