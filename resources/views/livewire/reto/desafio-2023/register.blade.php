    ...
    <section class="" style="">
        ...
        <div class="py-12 flex flex-col-reverse md:flex-row max-w-5xl mx-auto">
            <div class=" w-full md:w-6/12">
                <img src="{{asset('img/billboards/doctor_bayter_desafio_2023.jpg')}}" alt="" class="w-full my-4 md:my-0"/>
            </div>
            <div class="pl-2 w-full md:w-6/12 pr-2 mb-8 md:pl-12 md:pr-0 md:mb-0 ">
                <header class="leading-tight">
                    ...
                    <h1 class="text-3xl md:text-5xl font-bold leading-none pt-2">DESAFIO<span class="text-red-700">2023</span></h1>
                    <h2 class="text-base md:text-2xl">Liberate de la mierda de 2022</h2>
                </header>
        ...
        <div class="bg-gray-50 py-8">
            <p class="my-4 text-md mb-8 md:text-3xl max-w-5xl mx-auto text-center">Te voy a demostrar que tan solo en 5 días tu cuerpo estará listo para comer delicioso Y <b>BAJAR ESA MIERDA QUE ACUMULASTE EN EL 2022.</b></p>
        </div>
            ...
            <div class="text-gray-50  w-full lg:w-8/12  px-4 md:mr-0 md:ml-10">
                ...
                <ul class="text-sm md:text-base">
                    <li class="mb-4 relative pl-6 text-justify">
                        ...
                        <span class="">Todas las recetas: desayuno, almuerzo, cena de tu día a día, lista de alimentos y los mejores secretos para prepararte para el desafio.</span>
                    </li>
                     <li class="mb-4 relative pl-6 text-justify">
                        <i class="far fa-check-square text-yellow-400 mr-2 absolute top-1 left-0"></i>
    ...
    <section class="max-w-3xl py-24 mx-auto ">
            ...
            <div class="flex flex-col lg:flex-row items-center justify-between mb-16">
                ...
                <div class="lg:ml-10 px-4 lg:px-4">
                    <h2 class="font-semibold text-2xl lg:text-3xl mb-4 text-red-700">Conoce y domina tu alimentacion</h2>
                    <p class="text-justify ">No solo serán 5 días de recetas, serán 5 días de un acompañamiento exclusivo con el Equipo Keto Bayter, además de las reuniones por zoom en compañía del que más sabe de keto, Tu Doctor Bayter. </p>
                </div>
            </div>
            <div class="flex flex-col-reverse lg:flex-row items-center justify-between mb-16">
                <div class="lg:mr-10 px-4 lg:px-4">
    ...
    <section class="bg-gray-900 py-12  ">
        <article class="max-w-3xl mx-auto text-gray-50 px-6 ">
            <div class="mb-8 ">
                ...
                <h3 class="text-lg text-gray-200 leading-none"><b class="text-yellow-400">Fecha de inicio:</b> 10 de enero de 2023</h3>
            </div>
            ...
            <ul>
                <li class="mb-3 flex ">
                    ...
                    <p class=" flex-1">Martes 10 de enero, día 1: Reunión privada de zoom con tu Doctor Bayter + plan de alimentación + video receta </p>
                </li>
                <li class="mb-3 flex">
                    <p class=""><b class="mr-4 text-yellow-400">Día 2:</b></p>
                    <p class=" flex-1">Miércoles 11 de enero, día 2: Plan de alimentación + video receta </p>
                </li>
                <li class="mb-3 flex">
                    <p class=""><b class="mr-4 text-yellow-400">Día 3:</b></p>
                    <p class=" flex-1">Jueves 12 de enero, día 3: Plan de alimentación + video receta </p>
                </li>
                <li class="mb-3 flex">
                    <p class=""><b class="mr-4 text-yellow-400">Día 4:</b></p>
                    <p class=" flex-1">Viernes 13 de enero, día 4: Reunión privada de zoom con tu Doctor Bayter + Plan de alimentación + video receta </p>
                </li>
                <li class="mb-3 flex">
                    <p class=""><b class="mr-4 text-yellow-400">Día 5:</b></p>
                    <p class=" flex-1">Sábado 14 de enero, día 5: Plan de alimentación + video receta</p>
                </li>
            </ul>
        </article>
    </section>
