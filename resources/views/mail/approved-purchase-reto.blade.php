                    ...
                    <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                      <tr>
                        <td style="text-align:center;width:260px;padding:0;vertical-align:top;color:#153643;">
                          ...
                          <p style="margin:0;font-size:24px;line-height:24px;font-family:Arial,sans-serif;"><a href="https://chat.whatsapp.com/GliC6WZEW0CL04boWOrLBJ" style="color:#a30000;text-decoration:underline;">Entra aquí al grupo de WhatsApp</a></p>
                        </td>
                      </tr>
                    </table>
                  </td>
