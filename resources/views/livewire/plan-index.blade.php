                        ...
                        <section class="mb-24">
                            ...
                            <section class="grid md:grid-cols-2 gap-12  max-w-screen-md">
                                ...
                                <article class="hover:opacity-90 overflow-hidden rounded-xl shadow-x">
                                    ...
                                    @elseif (auth()->user()->fases->whereNotIn('id', [8, 9, 10, 11, 12, 13, 14, 15, 16])->first())
                                            ...
                                            <div class="py-8 px-8 rounded-2xl  border-dashed border-red-700 border-4 bg-gray-200">
                                                ...
                                                <div class="flex-col md:flex-row justify-around my-8">
                                                    <div class="bg-gray-300 p-8 rounded-xl border border-gray-700 mb-8">
                                                        <div class="">
                                                            <h2>Primera Reunión <b>Desafio 2023</b></h2>
                                                            <hr class="my-2 border-gray-700">
                                                            <p><b>La repetición estará disponible por tiempo limitado</b></p>
                                                            <a href="{{route('reto.replay', ['desafio-2023', 1])}}" target="_blank" class="cursor-pointer inline-block mt-4 text-center text-sm font-bold px-4 py-2 rounded-full border bg-red-700 border-red-700 text-gray-50 uppercase transition-colors duration-300 ease-in-out hover:bg-transparent  hover:text-red-700">Mira aquí la repetición</a>
                                                        </div>
                                                        <div class="hidden">
                                                            <h2>Primera Reunión <b>Desafio 2023</b></h2>
                                                            <hr class="my-2 border-gray-700">
                                                            <p><b>Fecha:</b> 10 de enero 2023 1:00 p.m. Hora Colombia</p>
                                                            <p><b>ID de reunión:</b> 886 5044 3170</p>
                                                            <p><b>Código de acceso:</b> 316913</p>
                                                            <a href="https://us02web.zoom.us/j/88650443170?pwd=Z3NSb2RjMXdndW45YnF4NlQ4SU56UT09" target="_blank" class="cursor-pointer inline-block mt-4 text-center text-sm font-bold px-4 py-2 rounded-full border bg-red-700 border-red-700 text-gray-50 uppercase transition-colors duration-300 ease-in-out hover:bg-transparent  hover:text-red-700">Link de acceso a la reunión</a>
                                                        </div>
                                                    </div>
                                                    <div class="bg-gray-300 p-8 rounded-xl border border-gray-700 mb-8 ">
                                                        <div class="">
                                                            <h2>Repetición Segunda Reunión <b>Desafio 2023</b></h2>
                                                            <hr class="my-2 border-gray-700">
                                                            <p><b>La repetición estará disponible por tiempo limitado</b></p>
                                                            <a href="{{route('reto.replay', ['desafio-2023', 2])}}" target="_blank" class="cursor-pointer inline-block mt-4 text-center text-sm font-bold px-4 py-2 rounded-full border bg-red-700 border-red-700 text-gray-50 uppercase transition-colors duration-300 ease-in-out hover:bg-transparent  hover:text-red-700">Mira aquí la repetición</a>
                                                        </div>
                                                        <div class="hidden">
                                                            <h2>Segunda Reunión <b>Desafio 2023</b></h2>
                                                            <hr class="my-2 border-gray-700">
                                                            <p><b>Fecha:</b> 13 de enero 2023 1:00 p.m. Hora Colombia</p>
                                                            <p><b>ID de reunión:</b> 885 7157 4057</p>
                                                            <p><b>Código de acceso:</b> 073801</p>
                                                            <a href="https://us02web.zoom.us/j/88571574057?pwd=cEhlL3IvN0htZ092RDhZdWRsV3Brdz09" class="cursor-pointer inline-block mt-4 text-center text-sm font-bold px-4 py-2 rounded-full border bg-red-700 border-red-700 text-gray-50 uppercase transition-colors duration-300 ease-in-out hover:bg-transparent  hover:text-red-700">Link de acceso a la reunión</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
