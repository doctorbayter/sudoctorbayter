    ...
    <section class="" style="">
        ...
        <div class="py-12 flex flex-col-reverse md:flex-row max-w-5xl mx-auto">
            <div class=" w-full md:w-6/12">
                <img src="{{asset('img/billboards/reto_empareja2-2023.jpg')}}" alt="" class="w-full my-4 md:my-0"/>
            </div>
    ...
    <section class="bg-gray-900 py-12  ">
        <article class="max-w-3xl mx-auto text-gray-50 px-6 ">
            <div class="mb-8 ">
                ...
                <h3 class="text-lg text-gray-200 leading-none"><b class="text-yellow-400">Fecha de inicio:</b> 13 de junio 2023</h3>
            </div>
            ...
            <ul>
                <li class="mb-3 flex ">
                    ...
                    <p class=" flex-1">día 1: Reunión privada de zoom con tu Doctor Bayter + plan de alimentación + video receta </p>
                </li>
                <li class="mb-3 flex">
                    <p class=""><b class="mr-4 text-yellow-400">Día 2:</b></p>
                    <p class=" flex-1">día 2: Plan de alimentación + video receta</p>
                </li>
                <li class="mb-3 flex">
                    <p class=""><b class="mr-4 text-yellow-400">Día 3:</b></p>
                    <p class=" flex-1">día 3: Plan de alimentación + video receta </p>
                </li>
                <li class="mb-3 flex">
