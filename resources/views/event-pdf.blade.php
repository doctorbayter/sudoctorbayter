        ...
        <div class="max-w-2xl  mx-auto px-6 lg:px-8 flex relative overflow-hidden py-16 md:py-16 text-center">
            <div class="bg-gray-900 text-gray-50 w-full py-8 px-8 rounded-xl shadow-sm">
                ...
                <div class="mb-4 leading-none">
                    <p class="font-semibold ">Genera tu certificado de participación</p>
                    <small>Escribe el correo exactamente como lo hiciste al momento de comprar tu entrada</small>
                </div>
                <form action="{{route('event.pdf')}}" method="GET">

                    <div class="form-group row">
                      <div class="col-sm-10">
                        <input name="email" type="text" class="form-control w-full border-none py-4 px-2 mb-4  rounded-xl text-black"  placeholder="Escribe tu correo aquí...">
                      </div>
                    </div>

                    <div class="form-group row">
                      <div class="col-sm-10">
                        <button type="submit" class="w-full font-bold  py-4 rounded-xl bg-red-700 mb-6">GENERAR CERTIFICADO</button>
                      </div>
                    </div>
                  </form>
                <hr class="my-4">
                <footer class="leading-none mt-8 ">
                    <p>Si tienes problemas validando tu certificado por favor contacta con nuestro equipo de soporte.</p>
