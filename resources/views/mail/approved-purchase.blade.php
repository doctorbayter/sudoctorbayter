                    ...
                    <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                      <tr>
                        ...
                        <td style="width:260px;padding:0;vertical-align:top;color:#153643;">
                          ...
                          <p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><a href="{{route('plan.whatsapp')}}" style="color:#a30000;text-decoration:underline;">Entra aquí al chat</a></p>
                        </td>
                      </tr>
                    </table>
                  </td>
