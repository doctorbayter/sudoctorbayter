                            ...
                            <div>
                                <a href="{{route('plan.recipe', $salsita)}}">
                                    <div class="relative h-62">
                                        <img src="{{asset('img/'.$salsita->image->url)}}" alt="" class="rounded-2xl object-cover">
                                    </div>
                                    <div class="mt-2 ml-4">
                                        <p class="text-2xl mb-2 font-bold text-gray-900">{{$salsita->name}}</p>
                                        <div class="flex text-xs items-center">
                                        <p class="bg-green-500 px-2 py-1 rounded-lg inline-block text-white">{{$salsita->carbs}}gr Carbs.</p>
                                        ...
                                        <p class="text-gray-400 ml-2 flex items-center">
                                            ...
                                            <span>{{$salsita->time}} minutos</span>
                                        </p>
                                        </div>
                                    </div>
                                </a>
